...
@section('content')
    ...
    <div class="card mt-4">
        <div class="card-header">
            <a href="/admin/products?page={{ $page }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="cth: 22.500" class="form-control number-format"
                                        id="buy_price" name="buy_price" value="{{ $product->buy_price ?? '' }}">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="name" class="form-label">Harga Jual <span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="cth: 28.000" class="form-control number-format"
                                        id="sell_price" name="sell_price" value="{{ $product->sell_price ?? '' }}">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="name" class="form-label">Kalkulasi Harga Modal <span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="cth: 28.000" class="form-control" disabled
                                        readonly value="{{ $product->modal ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
